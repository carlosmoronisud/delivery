import { List, ShoppingCartSimple, User, X, MapPinLine, MagnifyingGlass } from "@phosphor-icons/react";
...
function Navbar({ menuState, onMenuToggle, onMenuClose }: Readonly<NavbarProps>) {
    ...
    const { formattedAddress } = useContext(UserLocationContext); // Use o endereço formatado do contexto
            ...
            <div className='fixed md:relative top-0 left-0 z-50 w-full bg-gray-50 text-gray-800 flex justify-center py-4 shadow-md'>
                <div className="container mx-auto px-6 md:px-8 flex items-center justify-between text-lg font-medium">
                    ...
                    <div className="hidden md:flex flex-grow items-center justify-center gap-4 mx-8">
                        {/* Localização */}
                        <Link to="/home" className="flex items-center gap-2 p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200 cursor-pointer max-w-[250px] overflow-hidden text-ellipsis whitespace-nowrap" title="Alterar endereço">
                            <MapPinLine size={24} weight="fill" className="text-orange-600 flex-shrink-0" />
                    ...
                    <div className='hidden md:flex items-center gap-6'>
                        {/* Links principais como "Produtos", "Categorias" poderiam ir aqui ou no menu mobile */}
            ...
            {menuState === 'open' && (
                ...
                >
                    <div className="relative flex flex-col items-start justify-start gap-4 p-6 text-left text-lg text-white">
                        ...
                        {/* Endereço no Menu Mobile */}
                        <div className="flex items-center gap-2 p-2 w-full rounded-lg bg-gray-700 text-white font-semibold text-base mb-4">
                            <MapPinLine size={24} weight="fill" className="text-orange-400" />
